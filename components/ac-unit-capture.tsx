...
export default function ACUnitCapture() {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        ...
        dispatch({ type: "SET_AC_UNIT_IMAGE", payload: result })
      }
  ...
  return (
    <SharedLayout showBack currentStep={4}>
      <div className="space-y-4">
        <h1 className="text-[#2D2D2D] text-2xl font-medium tracking-tight">Take a photo of your AC unit</h1>
        <p className="text-gray-600 text-lg">
          Capture a clear image of your mini split or AC unit, including any visible model numbers or specifications.
        </p>
      </div>
