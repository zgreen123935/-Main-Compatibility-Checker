        ...
        <div className="max-w-md mx-auto w-full space-y-8 flex-1 flex flex-col">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-lg">
              Make sure the entire thermostat is visible and any model number is easy to read.
            </p>
          </div>
          ...
          {uploadedImage && (
            <Button
              ...
              onClick={() => router.push("/capture/wiring")}
            >
              Continue
            </Button>
          )}
