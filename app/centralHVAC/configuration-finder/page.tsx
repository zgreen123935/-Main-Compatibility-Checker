...
export default function ConfigurationFinder() {
  ...
  const handleReset = () => {
    ...
    setShowHeatPumpValidation(false) // Add this line
    setConfigCode("")
    setAlternativeCode("")
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-[#6B7280]">
            <Link href="/centralHVAC" className="hover:text-[#2D2D2D]">
              Central HVAC Manual
            </Link>
            <span>/</span>
            <span className="text-[#2D2D2D]">Configuration Code Finder</span>
          </div>
        </div>
      </div>
          ...
          {showSupportContact ? (
            ...
            <div>
              <div className="text-center mb-8">
                ...
                <h1 className="text-4xl font-medium text-[#2D2D2D] mb-4">Need Additional Support?</h1>
              ...
              <Card className="mb-8">
                <CardHeader className="bg-orange-50 text-center">
                  <CardTitle className="text-2xl text-[#2D2D2D]">Contact Mysa Support</CardTitle>
                </CardHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card className="border-2 border-[#BAE5D4] hover:shadow-lg transition-shadow">
                      <CardContent className="p-6 text-center">
                        <Phone className="w-12 h-12 text-[#2D2D2D] mx-auto mb-4" />
                        <h3 className="text-lg font-medium text-[#2D2D2D] mb-2">Phone Support</h3>
                        <p className="text-[#6B7280] mb-4">Speak directly with our technical support team</p>
                        <Button className="bg-[#2D2D2D] hover:bg-[#1a1a1a] text-white w-full">Call Support</Button>
                        <p className="text-sm text-[#6B7280] mt-2">Mon-Fri 9AM-5PM EST</p>
                      </CardContent>
                    </Card>

                    <Card className="border-2 border-[#BAE5D4] hover:shadow-lg transition-shadow">
                      <CardContent className="p-6 text-center">
                        <Mail className="w-12 h-12 text-[#2D2D2D] mx-auto mb-4" />
                        <h3 className="text-lg font-medium text-[#2D2D2D] mb-2">Email Support</h3>
                        <p className="text-[#6B7280] mb-4">Send us your wiring photos and system details</p>
                        <Button
                          variant="outline"
                          className="bg-transparent border-[#2D2D2D] text-[#2D2D2D] hover:bg-[#2D2D2D] hover:text-white w-full"
                        >
                          Email Support
                        </Button>
                        <p className="text-sm text-[#6B7280] mt-2">Response within 24 hours</p>
                      </CardContent>
                    </Card>
                  </div>

                  <div className="mt-8 p-4 bg-gray-50 rounded-lg">
                    <h4 className="font-medium text-[#2D2D2D] mb-2">What to include in your support request:</h4>
                    <ul className="text-[#6B7280] space-y-1 text-sm">
                      <li>• Clear photo of your current thermostat wiring</li>
                      <li>• Your HVAC system type (furnace, heat pump, etc.)</li>
                      <li>• Current thermostat brand and model</li>
                      <li>• Any unusual wire colors or configurations</li>
                    </ul>
                  </div>
                </CardContent>
              </Card>
            ...
            <>
              ...
              <div className="text-center mb-12">
                ...
                <h1 className="text-4xl font-medium text-[#2D2D2D] mb-4">Configuration Code Finder</h1>
                <p className="text-xl text-[#6B7280]">
              ...
              {formData.systemType === "not-sure" && detectedSystemType && currentStep === 2 && (
                <Alert className="mb-6 border-blue-200 bg-blue-50">
                  ...
                  <AlertDescription className="text-blue-800">
                    ...
                    <strong>{getSystemTypeName(detectedSystemType)}</strong>. If this doesn't seem right, you can go
                    back and select a different system type.
                  </AlertDescription>
                </Alert>
              )}
              ...
              <Card className="mb-8">
                <CardContent className="p-8">
                  {currentStep === 1 && (
                    <div>
                      <h2 className="text-2xl font-medium text-[#2D2D2D] mb-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        {Object.entries(getWireDescriptions()).map(([wire, description]) => (
                          <div key={wire} className="flex items-start space-x-3 p-4 border rounded-lg">
                            <Checkbox
                              id={wire}
                            ...
                            <Label htmlFor={wire} className="flex-1 cursor-pointer">
                              <div className="font-medium text-[#2D2D2D]">{wire} Wire</div>
                            ...
                            <AlertDescription className="text-red-800">
                              <div className="space-y-2">
                                ...
                                <div className="text-sm">
                                  <p className="font-medium mb-2">If you don't see a C-wire connected:</p>
                                  <ul className="list-disc list-inside space-y-1 ml-2">
                                    ...
                                    <li>
                                      You will need to install a C-Wire Power Adapter to provide the required power
                                    </li>
                                  </ul>
                                </div>
                                <div className="flex flex-col sm:flex-row gap-2 mt-3">
                                  <Button size="sm" className="bg-[#2D2D2D] hover:bg-[#1a1a1a] text-white">
                                    Already Have a C-Wire Adapter: Install Instructions
                                  </Button>
                                  <Button
                                    size="sm"
                                    variant="outline"
                                  ...
                                  >
                                    Don't Have a C-Wire Adapter: Buy One Now
                                  </Button>
                                </div>
                                <div className="mt-2">
                                  <Link href="/centralHVAC/c-wire-support">
                                    <Button
                                      size="sm"
                                      variant="link"
                                      className="text-red-700 hover:text-red-900 p-0 h-auto"
                                    >
                                      Learn More About C-Wire Requirements →
                                    </Button>
                                  </Link>
                                </div>
                              </div>
                        ...
                        <div className="flex items-start space-x-3 p-4 border-2 border-orange-200 rounded-lg bg-orange-50">
                          ...
                          <Label htmlFor="wireNotShown" className="flex-1 cursor-pointer">
                            <div className="font-medium text-orange-800">My Wire Is Not Shown</div>
                  ...
                  {currentStep === 3 && (
                    <div>
                      <h2 className="text-2xl font-medium text-[#2D2D2D] mb-4">Configuration Code</h2>
                  ...
                  <AlertDescription className="text-amber-800">
                    <div className="space-y-2">
                      <p>
                        ...
                        selected an O or B wire. It's very uncommon for heat pumps to not have one of these reversing
                        valve wires.
                      </p>
                      <p className="text-sm">
                        Heat pumps typically require either an O wire (orange) or B wire (blue/brown) to control the
                        reversing valve that switches between heating and cooling modes.
                      </p>
                      <div className="flex flex-col sm:flex-row gap-2 mt-3">
                        <Button
                          size="sm"
                        ...
                        <Button
                          ...
                          onClick={() => {
                            setShowHeatPumpValidation(false)
                            // Allow proceeding by temporarily bypassing validation
                            if (currentStep === 2) {
                              const effectiveSystemType =
                                formData.systemType === "not-sure" ? detectedSystemType : formData.systemType
                              if (effectiveSystemType !== "fan-coil") {
                                const primaryCode = generateConfigCode(false)
                                const altCode = generateConfigCode(true)
                                setConfigCode(primaryCode)
            ...
            <div>
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-[#6B7280]">Your Mysa configuration code has been generated</p>
              </div>

              <Card className="mb-8">
                <CardHeader className="bg-[#BAE5D4] text-center">
                  <CardTitle className="text-2xl text-[#2D2D2D]">Your Configuration Code</CardTitle>
                </CardHeader>
                <CardContent className="p-8 text-center">
                  <div className="bg-gray-100 rounded-lg p-6 mb-6">
                    <div className="text-4xl font-mono font-bold text-[#2D2D2D] mb-2">{configCode}</div>
                    <Button
                      variant="outline"
                      size="sm"
                  ...
                  <p className="text-[#6B7280] mb-6">Enter this code in the Mysa app during thermostat setup</p>
                </CardContent>
              </Card>

              {/* Heat Pump Feedback Section */}
              {detectedCapabilities.heatPump &&
                alternativeCode &&
                alternativeCode !== configCode &&
                !showAlternative && (
              ...
              {showAlternative && alternativeCode && (
                <Card className="mb-8 border-blue-200">
                  <CardHeader className="bg-blue-50 text-center">
                    <CardTitle className="text-2xl text-[#2D2D2D]">Alternative Configuration Code</CardTitle>
                  </CardHeader>
                  <CardContent className="p-8 text-center">
                    <div className="bg-gray-100 rounded-lg p-6 mb-6">
                      <div className="text-4xl font-mono font-bold text-[#2D2D2D] mb-2">{alternativeCode}</div>
                      <Button
                        variant="outline"
                        size="sm"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div>
                        <span className="font-medium text-[#2D2D2D]">System Type:</span>
                        <span className="ml-2 text-[#6B7280]">{configDetails?.type}</span>
                      </div>
                      <div>
                        <span className="font-medium text-[#2D2D2D]">Description:</span>
                        <p className="text-[#6B7280] mt-1">{configDetails?.description}</p>
                      </div>
                      <div>
                        <span className="font-medium text-[#2D2D2D]">Connected Wires:</span>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <span className="text-[#6B7280]">Heating:</span>
                        <span className={detectedCapabilities.heating ? "text-green-600" : "text-gray-400"}>
                          {detectedCapabilities.heating ? `${detectedCapabilities.stages.heat} Stage(s)` : "None"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#6B7280]">Cooling:</span>
                        <span className={detectedCapabilities.cooling ? "text-green-600" : "text-gray-400"}>
                          {detectedCapabilities.cooling ? `${detectedCapabilities.stages.cool} Stage(s)` : "None"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#6B7280]">Heat Pump:</span>
                        <span className={detectedCapabilities.heatPump ? "text-green-600" : "text-gray-400"}>
                          {detectedCapabilities.heatPump ? "Yes" : "No"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#6B7280]">Fan Control:</span>
                        <span className={detectedCapabilities.fanControl ? "text-green-600" : "text-gray-400"}>
                          {detectedCapabilities.fanControl ? "Yes" : "No"}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-[#6B7280]">Emergency Heat:</span>
                        <span className={detectedCapabilities.emergencyHeat ? "text-green-600" : "text-gray-400"}>
