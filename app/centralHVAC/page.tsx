...
import { ChevronDown, MapPin, ShoppingCart, FileText, AlertCircle, Menu, X, Smartphone, Apple } from "lucide-react"

import { Button } from "@/components/ui/button"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Badge } from "@/components/ui/badge"
import { Alert, AlertDescription } from "@/components/ui/alert"
import { ConfigurationFinderComponent } from "./configuration-finder/configuration-finder-component"
    ...
    switch (activeSection) {
              ...
              <div className="flex flex-col lg:flex-row items-center gap-12">
                <div className="flex-1 text-white">
                  ...
                  <p className="text-lg leading-relaxed">
                    Your online guide shows you how to easily set up, use, and troubleshoot your Mysa. Mysa for Central
                    HVAC is compatible with most forced air, heat pump, hydronic, and fan coil heating and cooling
                    systems.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-6">
                  <div className="flex-1">
                    ...
                    <p className="text-lg mb-4">
                      Installing this product involves handling high voltage wiring. Follow these installation
                      instructions carefully.
                    </p>
                    <p className="mb-4">
                      To avoid fire, personal injury, or death, turn off your circuit breakers and follow the proper
                    ...
                    <p className="text-sm">
                      The installation of the thermostat must comply with the applicable Local and/or National
      ...
      case "configuration":
        return (
          <section className="py-16 bg-white">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-3xl font-medium text-[#6B7280] text-center mb-8">Configuration Code Finder</h2>
              <p className="text-[#6B7280] text-center mb-12 max-w-4xl mx-auto">
                Use our interactive tool to find the right configuration code for your specific HVAC system. This tool
                will guide you through selecting your system type and wiring to generate the correct configuration.
              </p>
              <ConfigurationFinderComponent />
            </div>
          </section>
        )
